This is a fork from https://github.com/PaddlePaddle/DeepSpeech
...
```bash
docker pull jcadic/deepspeech:baidu
```
...
```bash
docker run -it --rm --gpus all -v $(pwd)/DeepSpeech:/DeepSpeech jcadic/deepspeech:baidu /bin/bash
```
